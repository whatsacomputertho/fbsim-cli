...
use crate::cli::league::team::stats::FbsimLeagueTeamStatsRushingArgs;

use serde_json;
use tabwriter::TabWriter;

pub fn list_rushing(args: FbsimLeagueTeamStatsRushingArgs) -> Result<(), String> {
